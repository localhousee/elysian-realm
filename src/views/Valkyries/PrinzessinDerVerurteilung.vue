          ...
          lists: [
            {
              ...
              desc: "Grants 1 stack of Blessing of Retribution every 7s. 2 stacks max. QTE consumes 1 stack to create a small lightning field which lasts 2s and deals 3x225% ATK of Lightning DMG per 0.4s to enemies within. Starts with 2 stacks",
              priority: "Start",
            },
            {
              name: "Blessing of Midnight",
              desc: "During Ultimate, Oz lingers on for 7s after the arrow rain. Every 7 hits from Oz on enemies within the Ultimate range summons dark lightning to deal 1500% ATK of Lightning DMG",
              priority: "1st",
            },
            {
              name: "Blessing of Fate",
              desc: "When hitting an enemy weakspot with a weapon active, Oz unleashes dark lightning to deal 2000% ATK of Lightning DMG",
              priority: "2nd",
            },
            {
              name: "Blessing of Nightfall",
              desc: "Weapon actives deal 200% bonus Total DMG. Summoning Oz with Charged ATK or casting Ultimate refills 2 weapon active charges",
              priority: "No",
            },
            {
              name: "Blessing of Dark Wings",
              desc: "When Ultimate Evasion Skill is triggered, Oz unleashes dark lightning to deal 4200% ATK of Lightning DMG",
              priority: "No",
            },
          ],
        },
