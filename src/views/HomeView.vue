<template>
  <h1 class="text-center uppercase font-thin text-[60px] tracking-widest pb-10">Elysian Realm</h1>
  ...
  <div>
    ...
    <TransitionRoot appear :show="aboutIsOpen" as="template">
      <Dialog as="div" @close="closeAbout">
              ...
              >
                ...
                <div class="mt-2 text-sm lg:text-md text-gray-800 mx-4">
                  ...
                  <ul class="list-disc">
                    ...
                    <li>Rafe#5610: helped rekindled the GC again and is also a rentry/vercel site editor</li>
                  ...
                  <ul class="list-disc">
                    ...
                    <li>SinsOfSeven#3164 (TencentDimepiece): tester and fellow guide maker <a class="text-blue-600 hover:underline hover:text-blue-500" target="_blank" href="https://rentry.org/elysian_realm_list">Signet list here</a></li>
  ...
  <div>
    ...
    <TransitionRoot appear :show="creditIsOpen" as="template">
      <Dialog as="div" @close="closeCredit">
        <div class="fixed inset-0 z-10 overflow-y-auto">
          <div class="min-h-screen px-4 text-center">
            <TransitionChild
              as="template"
              ...
              >
                ...
                <div class="mt-2">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-6 justify-items-stretch content-center">
                    ...
                    <a target="_blank" class="text-blue-600 hover:underline hover:text-blue-500" href="https://fr.freepik.com/vecteurs-premium/fond-pastel-paradis-arc-ciel_4626551.htm">Website Background</a>
...
<script setup>
  ...
  const creditIsOpen = ref(false)

  function closeAbout() {
    aboutIsOpen.value = false
  }
  function openAbout() {
    aboutIsOpen.value = true
  }
  function closeCredit() {
    creditIsOpen.value = false
  }
  function openCredit() {
    creditIsOpen.value = true
  }
</script>
